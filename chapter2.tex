...
\begin{figure}
  ...
  \caption[电子辐照的type \uppercase\expandafter{\romannumeral1}a型金刚石样品显微图片]{电子辐照的type \uppercase\expandafter{\romannumeral1}a型金刚石样品显微图片。浅色区域的空位和氮浓度较低，样品尺寸为\(1\times1\times0.5 \, \mathrm{mm^3}\) \cite{Kiflawi2007}。}
...
\begin{figure}
  ...
  \caption[含有缺陷的金刚石晶体的电子能级结构]{含有缺陷的金刚石晶体的电子能级结构。（a）带隙之间的施主和受主能级会使电子发生在价带和缺陷能级（\uppercase\expandafter{\romannumeral1}）或缺陷能级和导带（\uppercase\expandafter{\romannumeral2}）之间的光学跃迁。（b）电子在施主和受主能级之间的光学跃迁\cite{Staudacher2015}。}
...
\begin{figure}
  \centering
  \includegraphics[width=1.0\textwidth]{figures/Chapter 2/NV Spectrum.png}
...
\begin{figure}
  \centering
  \includegraphics[width=1.0\textwidth]{figures/Chapter 2/XY8 Sequence.png}
